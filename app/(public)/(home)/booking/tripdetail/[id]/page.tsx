...
const TripDetails = () => {
    ...
    const formatTime = (isoString?: string): string => {
        ...
        try {
            ...
            if (!isValid(date)) {
                console.warn(
                    'formatTime: Invalid date from isoString:',
                    isoString
                );
                return 'N/A';
            }
    ...
    const calculateArrivalTime = (
        ...
        if (!startTime || duration === undefined) {
            console.warn(
                'calculateArrivalTime: Missing startTime or duration',
                {
                    startTime,
                    duration,
                }
        ...
        try {
            ...
            if (!isValid(startDate)) {
                console.warn(
                    'calculateArrivalTime: Invalid startDate:',
                    startTime
                );
                return 'N/A';
            }
    ...
    if (
        ...
        console.error(
            'Invalid trip data: Missing or invalid coordinates',
            trip
        );
    }
    ...
    return (
        <div className="mx-auto p-4 md:p-6 max-w-5xl space-y-6 bg-[var(--background)]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <RouteRequestDialog routeId={tripId} seats={1}/>
            </div>
        </div>
    );
};
